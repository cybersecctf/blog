...
def reverse_operation(result, original_key):
    reversed_text = ""
    key = original_key

    for d in result:
        for c in range(400):  # assuming the text is in ASCII
